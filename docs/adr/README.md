...
| [0018](0018-modules-reach-by-name.md) | A module reaches another by a published name, never by a path | accepted — extended by [0020](0020-assembled-composition.md) |
...
| [0020](0020-assembled-composition.md) | The composition is assembled by a tool, not recomposed by the agent | accepted |
...
| **The project** — every module it ships, and what an agent reads before acting | 0020 (the composition is assembled by a tool, completing 0009 and 0018) |
