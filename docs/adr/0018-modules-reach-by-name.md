...
**Status**: accepted — 2026-08-11 — extended by [0020](0020-skill-extension-protocol.md), which answers for documents what this ADR answers for executables, and makes the PATH behaviour recorded below load-bearing beyond these two call sites: it reads the module roots out of PATH rather than a name written into a skill.
