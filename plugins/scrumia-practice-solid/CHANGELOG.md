# Changelog — scrumia-practice-solid
...
## [0.4.0] - 2026-08-10
### Added
- The `practices` slot for SOLID, applied app by app: each principle with the limit past which applying it costs more than it saves.
