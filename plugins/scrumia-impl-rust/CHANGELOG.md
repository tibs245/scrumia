...
### Changed
- **Breaking — the project override moves to `.scrumia/overrides/scrumia-impl-rust.md`,
  from `.scrumia/impl/scrumia-impl-rust.md`.** `.scrumia/impl/` and
...
- `scrumia-rust` — the routing index; `scrumia-rust-audit` — the audit against it.
