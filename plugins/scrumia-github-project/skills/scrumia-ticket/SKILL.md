...
4. Whichever other files listed under `catalog` the index marks relevant — a rule, an interface, or a technical choice the ticket touches
5. The code neighboring the area to modify
