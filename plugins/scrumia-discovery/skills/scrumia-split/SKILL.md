...
- The footprint, at the grain a split can know: which apps, which shared surfaces this unit **creates for the units after it** and which it **reuses** from the units before; refinement completes the four entries (reuses, creates, retires, surfaces)
