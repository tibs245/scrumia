...
| File | Read it when |
|---|---|
| `business.md` | the ticket lifecycle, the milestone/epic vocabulary, label consumers, where a deviation from the execution policy is recorded, how a commit references its issue and where the close is written, the slot's scope per ADR-0013 |
